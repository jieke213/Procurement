...
public class RequestCode {
    //我的订单
    public static final int APPLYCLAIMS_MYORDER = 1;//申请报销
    public static final int CANCEL_ORDER = 12;//取消订单


    //验货员订单
    public static final int CHECKPASS_TOCHECK = 2;//验货通过
    public static final int PARTARRIVAL_TOCHECK = 3;//部分到货
    public static final int COMPLETEREFUND_TOCHECK = 4;//全部退货

    public static final int CHECKPASS_PARTARRIVAL = 5;//验货通过
    public static final int PARTARRIVAL_PARTARRIVAL = 6;//部分到货
    public static final int COMPLETEREFUND_PARTARRIVAL = 7;//全部退货
