 ...
 */
public class CategoryAgriculturalFragment extends BaseFragment4Category {
    private View view;
    private MainActivity mainActivity;

    private GridView gv_category_agricultural;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_category_agricultural,null);
        ...
        gv_category_agricultural.setAdapter(adapter);

        return view;
    }

    private void initView() {
        gv_category_agricultural= (GridView) view.findViewById(R.id.gv_category_agricultural);
    }
