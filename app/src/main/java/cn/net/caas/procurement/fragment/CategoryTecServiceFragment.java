 ...
 */
public class CategoryTecServiceFragment extends BaseFragment4Category {
    private View view;
    private MainActivity mainActivity;

    private GridView gv_category_tecservice;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_category_tecservice,null);
        ...
        gv_category_tecservice.setAdapter(adapter);

        return view;
    }

    private void initView() {
        gv_category_tecservice= (GridView) view.findViewById(R.id.gv_category_tecservice);
    }
