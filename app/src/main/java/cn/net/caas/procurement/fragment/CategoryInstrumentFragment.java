 ...
 */
public class CategoryInstrumentFragment extends BaseFragment4Category {
    private View view;
    private MainActivity mainActivity;

    private GridView gv_category_instrument;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_category_instrument,null);
        ...
        gv_category_instrument.setAdapter(adapter);

        return view;
    }

    private void initView() {
        gv_category_instrument= (GridView) view.findViewById(R.id.gv_category_instrument);
    }
