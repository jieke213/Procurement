 ...
 */
public class MyOrderDetailActivity4Tocheck extends AppCompatActivity implements View.OnClickListener{
    private Toolbar toolbar=null;
    private TextView tv_status_detail_tocheck;
    private TextView tv_leaderNick_detail_tocheck;
    private TextView tv_sellerNick_detail_tocheck;
    private LinearLayout layout_goods_detail_tocheck;
    private TextView tv_supplierOrderId_detail_tocheck;
    private TextView tv_createTime_detail_tocheck;
    private TextView tv_amountStr_detail_tocheck;

    private LinearLayout layout_progress_detail_tocheck;
    private LinearLayout scrollview_detail_tocheck;

    private Button btn_checkPass_tocheck;
    private Button btn_partArrival_tocheck;
    private Button btn_completeRefund_tocheck;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_myorderdetail4tocheck);
        ...
        //之前的方式
//        if (status_fromorder == Constants.DELIVERED){
//            showOrderDetail4Tocheck(access_token,ID,ID2);
//        }else{
...
//        }
    ...
    private void showOrderDetail4All(String access_token, final int mainOrderId, final int childOrderId) {
        layout_progress_detail_tocheck.setVisibility(View.VISIBLE);
        scrollview_detail_tocheck.setVisibility(View.INVISIBLE);
                        ...
                        if (ID == mainOrderId){
                            ...
                            for (int j = 0; j < supplierOrders.length(); j++) {
                                ...
                                if (ID2 == childOrderId){
                                    ...
                                    layout_goods_detail_tocheck.removeAllViews();
                                    for (int k = 0; k < orderItemList.length(); k++) {
                                        ...
                                        LinearLayout layout_row= (LinearLayout) LayoutInflater.from(MyOrderDetailActivity4Tocheck.this).inflate(R.layout.layout_goods_orderdetail,null);
                                        ...
                                        layout_goods_detail_tocheck.addView(layout_row);
                                    }
                                    tv_leaderNick_detail_tocheck.setText(leaderNick);
                                    tv_sellerNick_detail_tocheck.setText(sellerNick);
                                    tv_supplierOrderId_detail_tocheck.setText(String.valueOf(supplierOrderId));
                                    tv_createTime_detail_tocheck.setText(createTime);
                                    tv_amountStr_detail_tocheck.setText("¥ "+amountStr);

                                    layout_progress_detail_tocheck.setVisibility(View.INVISIBLE);
                                    scrollview_detail_tocheck.setVisibility(View.VISIBLE);
                                }
                            }
                        }
                    }
    ...
    private void initView() {
        //Toolbar
        toolbar= (Toolbar) findViewById(R.id.toolbar_myorderdetail_tocheck);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowTitleEnabled(false);

        tv_status_detail_tocheck= (TextView) findViewById(R.id.tv_status_detail_tocheck);
        tv_leaderNick_detail_tocheck= (TextView) findViewById(R.id.tv_leaderNick_detail_tocheck);
        tv_sellerNick_detail_tocheck= (TextView) findViewById(R.id.tv_sellerNick_detail_tocheck);
        layout_goods_detail_tocheck= (LinearLayout) findViewById(R.id.layout_goods_detail_tocheck);
        tv_supplierOrderId_detail_tocheck= (TextView) findViewById(R.id.tv_supplierOrderId_detail_tocheck);
        tv_createTime_detail_tocheck= (TextView) findViewById(R.id.tv_createTime_detail_tocheck);
        tv_amountStr_detail_tocheck= (TextView) findViewById(R.id.tv_amountStr_detail_tocheck);

        layout_progress_detail_tocheck= (LinearLayout) findViewById(R.id.layout_progress_detail_tocheck);
        scrollview_detail_tocheck= (LinearLayout) findViewById(R.id.scrollview_detail_tocheck);

        btn_checkPass_tocheck= (Button) findViewById(R.id.btn_checkPass_tocheck);
        btn_partArrival_tocheck= (Button) findViewById(R.id.btn_partArrival_tocheck);
        btn_completeRefund_tocheck= (Button) findViewById(R.id.btn_completeRefund_tocheck);
        btn_checkPass_tocheck.setOnClickListener(this);
        btn_partArrival_tocheck.setOnClickListener(this);
        btn_completeRefund_tocheck.setOnClickListener(this);
        btn_checkPass_tocheck.setVisibility(View.GONE);
        btn_partArrival_tocheck.setVisibility(View.GONE);
        btn_completeRefund_tocheck.setVisibility(View.GONE);
    }

    private void initData(int status) {
        switch (status){
            case Constants.LEADER_REVIEW:
                tv_status_detail_tocheck.setText("课题组长审核中");
                btn_checkPass_tocheck.setVisibility(View.GONE);
                btn_partArrival_tocheck.setVisibility(View.GONE);
                btn_completeRefund_tocheck.setVisibility(View.GONE);
                break;
            case Constants.INSTIUTE_REVIEW:
                tv_status_detail_tocheck.setText("研究所审核中");
                btn_checkPass_tocheck.setVisibility(View.GONE);
                btn_partArrival_tocheck.setVisibility(View.GONE);
                btn_completeRefund_tocheck.setVisibility(View.GONE);
                break;
            case Constants.REVIEW_PASS:
                tv_status_detail_tocheck.setText("审核通过");
                btn_checkPass_tocheck.setVisibility(View.GONE);
                btn_partArrival_tocheck.setVisibility(View.GONE);
                btn_completeRefund_tocheck.setVisibility(View.GONE);
                break;
            case Constants.CONFIRM_ORDER:
                tv_status_detail_tocheck.setText("订单确认");
                btn_checkPass_tocheck.setVisibility(View.GONE);
                btn_partArrival_tocheck.setVisibility(View.GONE);
                btn_completeRefund_tocheck.setVisibility(View.GONE);
                break;
            case Constants.DELIVERED:
                tv_status_detail_tocheck.setText("已发货");
                btn_checkPass_tocheck.setVisibility(View.VISIBLE);
                btn_partArrival_tocheck.setVisibility(View.VISIBLE);
                btn_completeRefund_tocheck.setVisibility(View.VISIBLE);
                break;
            case Constants.CHECKING:
                tv_status_detail_tocheck.setText("部分到货");
                btn_checkPass_tocheck.setVisibility(View.VISIBLE);
                btn_partArrival_tocheck.setVisibility(View.VISIBLE);
                btn_completeRefund_tocheck.setVisibility(View.VISIBLE);
                break;
            case Constants.ORDER_DONE:
                tv_status_detail_tocheck.setText("订单完成");
                btn_checkPass_tocheck.setVisibility(View.GONE);
                btn_partArrival_tocheck.setVisibility(View.GONE);
                btn_completeRefund_tocheck.setVisibility(View.GONE);
                break;
            case Constants.LEADER_REVIEW_EXPENSES_CLAIMS:
                tv_status_detail_tocheck.setText("课题组长报销审核中");
                btn_checkPass_tocheck.setVisibility(View.GONE);
                btn_partArrival_tocheck.setVisibility(View.GONE);
                btn_completeRefund_tocheck.setVisibility(View.GONE);
                break;
            case Constants.INSTIUTE_REVIEW_EXPENSES_CLAIMS:
                tv_status_detail_tocheck.setText("研究所报销审核中");
                btn_checkPass_tocheck.setVisibility(View.GONE);
                btn_partArrival_tocheck.setVisibility(View.GONE);
                btn_completeRefund_tocheck.setVisibility(View.GONE);
                break;
            case Constants.CLAIMING:
                tv_status_detail_tocheck.setText("报销中");
                btn_checkPass_tocheck.setVisibility(View.GONE);
                btn_partArrival_tocheck.setVisibility(View.GONE);
                btn_completeRefund_tocheck.setVisibility(View.GONE);
                break;
            case Constants.DONE_EXPENSES_CLAIMS:
                tv_status_detail_tocheck.setText("完成报销");
                btn_checkPass_tocheck.setVisibility(View.GONE);
                btn_partArrival_tocheck.setVisibility(View.GONE);
                btn_completeRefund_tocheck.setVisibility(View.GONE);
                break;
            case Constants.REVIEW_NOT_PASS:
                tv_status_detail_tocheck.setText("审核未通过");
                btn_checkPass_tocheck.setVisibility(View.GONE);
                btn_partArrival_tocheck.setVisibility(View.GONE);
                btn_completeRefund_tocheck.setVisibility(View.GONE);
                break;
            case Constants.CANCEL_ORDER:
                tv_status_detail_tocheck.setText("取消订单");
                btn_checkPass_tocheck.setVisibility(View.GONE);
                btn_partArrival_tocheck.setVisibility(View.GONE);
                btn_completeRefund_tocheck.setVisibility(View.GONE);
                break;
            case Constants.REFUNDED_PRODUCTS:
                tv_status_detail_tocheck.setText("已退货");
                btn_checkPass_tocheck.setVisibility(View.GONE);
                btn_partArrival_tocheck.setVisibility(View.GONE);
                btn_completeRefund_tocheck.setVisibility(View.GONE);
                break;
            case Constants.REVIEW_EXPENSES_CLAIMS_NOT_PASS:
                tv_status_detail_tocheck.setText("报销未通过");
                btn_checkPass_tocheck.setVisibility(View.GONE);
                btn_partArrival_tocheck.setVisibility(View.GONE);
                btn_completeRefund_tocheck.setVisibility(View.GONE);
                break;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btn_checkPass_tocheck:
                Intent intent=new Intent(this, CheckPassActivity.class);
                ...
                startActivityForResult(intent, RequestCode.CHECKPASS_TOCHECK);
                break;
            case R.id.btn_partArrival_tocheck:
                Intent intent2=new Intent(this, PartArrivalActivity.class);
                ...
                startActivityForResult(intent2,RequestCode.PARTARRIVAL_TOCHECK);
                break;
            case R.id.btn_completeRefund_tocheck:
                Intent intent3=new Intent(this, CompleteRefundActivity.class);
                ...
                startActivityForResult(intent3,RequestCode.COMPLETEREFUND_TOCHECK);
                break;
            default:
                break;
        }
