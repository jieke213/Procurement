 ...
 */
public class CategoryConsumablesFragment extends BaseFragment4Category {
    private View view;
    private MainActivity mainActivity;

    private GridView gv_category_consumables;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_category_consumables,null);
        ...
        gv_category_consumables.setAdapter(adapter);

        return view;
    }

    private void initView() {
        gv_category_consumables= (GridView) view.findViewById(R.id.gv_category_consumables);
    }
